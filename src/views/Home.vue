  ...
  <div class="text-center container-lg">
    ...
    <b-link>
      <div class="d-flex justify-content-center align-items-center">
        ...
        >
          Silk Nodes Dashboard<small class="flow-left">Beta</small>
        </h1>
      </div>
    </b-link>

    <p class="mb-1">
      Silk Nodes Dashboard is not just an explorer but also a wallet and more ... 🛠<br>
      Credit must be givin to Ping.Pub the original developer of this explorer to which we have forked to make our own. 💜
    </p>
    <h2 class="mb-3">
